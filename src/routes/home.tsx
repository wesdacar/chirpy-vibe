                ...
                <div className="flex flex-col items-center size-full">
                        <div className="rounded-md mt-46 w-full max-w-2xl overflow-hidden">
                                ...
                                <div className="px-6 p-8 flex flex-col items-center z-10">
                                        <h1 className="text-shadow-sm text-shadow-purple-200 dark:text-shadow-purple-900 font-medium leading-[1.1] tracking-tight text-6xl w-full mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-500">
